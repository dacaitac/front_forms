// Este código fue adaptado de https://www.npmjs.com/package/node-gis-wrapper
// Se hicieron ajustes en el endpoint de la linea 26 y en la expresion regular de la 27
...
function EXPA(username, password, enforceSSL){
	...
	var tokenRequest = function(){
		...
		r.get('https://expa.aiesec.org/auth', (error, response, body) => {			
			var match = body.match('<input type="hidden" name="authenticity_token" value="(.*==)" />');
			//console.log(match);
